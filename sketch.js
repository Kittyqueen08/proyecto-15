  ...
  if(path.y > 400 ){
    ...
    if (cashG.isTouching(boy)) {
      ...
      // treasureCollection= treasureCollection - 150;
       treasureCollection= treasureCollection + 150;
       //aumenta 150 el puntaje cuando el jewelryG esta tocando al corredor
      ...
      if(swordGroup.isTouching(boy)) {
        ...
        // boy.addAnimation(endImg);
         ...
         //pone la animación endImg cuando el corredor toque a Sword Group
        ...
        cashG.destroyEach();
         ...
         jewelryG.destroyEach();
         swordGroup.destroyEach();
         //destruye a todos los grupos mencionados
